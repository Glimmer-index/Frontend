document.addEventListener('DOMContentLoaded', function () {
    ...
    var compTops = document.querySelectorAll('.comp_top');
    compTops.forEach(function (e) {
    ...
    var compBottoms = document.querySelectorAll('.comp_bottom');
    compBottoms.forEach(function (e) {
        e.addEventListener('click', function (event) {
            event.stopPropagation();
