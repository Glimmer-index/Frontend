document.addEventListener('DOMContentLoaded', function () {
    ...
    var jobTopRights = document.querySelector('.job_top_right');
    jobTopRights.addEventListener('click', function () {
        window.location.href = 'comp.html';
    });

    var jobBosss = document.querySelector('.job_boss');
    jobBosss.addEventListener('click', function (event) {
        event.preventDefault();
        event.stopPropagation();
        window.location.href = 'chat.html';
    });
