document.addEventListener("DOMContentLoaded", function () {
    ...
    var checkWindow = document.querySelector(".upload_check");
    var checkClose = document.querySelector(".check_close");
    var checkBtnNo = document.querySelector(".check_btn_no");
    var checkBtnYes = document.querySelector(".check_btn_yes");
    ...
    checkBtnNo.addEventListener("click", function () {
        checkWindow.style.display = "none";
        overlayUpload.style.display = "none";
    });

    checkBtnYes.addEventListener("click", function () {
        checkWindow.style.display = "none";
        overlayUpload.style.display = "none";
    });
